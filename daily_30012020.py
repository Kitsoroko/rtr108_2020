...
>>> 
============== RESTART: /home/user/rtr108_2020/python_tests.py ==============
{'__name__': '__main__', '__doc__': None, '__package__': None, '__loader__': <class '_frozen_importlib.BuiltinImporter'>, '__spec__': None, '__annotations__': {}, '__builtins__': <module 'builtins' (built-in)>, '__file__': '/home/user/rtr108_2020/python_tests.py'}
{'__name__': '__main__', '__doc__': None, '__package__': None, '__loader__': <class '_frozen_importlib.BuiltinImporter'>, '__spec__': None, '__annotations__': {}, '__builtins__': <module 'builtins' (built-in)>, '__file__': '/home/user/rtr108_2020/python_tests.py'}
{'__name__': '__main__', '__doc__': None, '__package__': None, '__loader__': <class '_frozen_importlib.BuiltinImporter'>, '__spec__': None, '__annotations__': {}, '__builtins__': <module 'builtins' (built-in)>, '__file__': '/home/user/rtr108_2020/python_tests.py', 'a': 10}
>>> __builtins__.__doc__
"Built-in functions, exceptions, and other objects.\n\nNoteworthy: None is the `nil' object; Ellipsis represents `...' in slices."
>>> pritnt(__builtins__.__doc__)
Traceback (most recent call last):
  File "<pyshell#1>", line 1, in <module>
    pritnt(__builtins__.__doc__)
NameError: name 'pritnt' is not defined
>>> pritn(__builtins__.__doc__)
Traceback (most recent call last):
...
-0.8390715290764524
Traceback (most recent call last):
  File "/home/user/rtr108_2020/python_tests.py", line 16, in <module>
    print(cos_V1(a))
